...
class MusicBot(discord.Client):
    ...
    async def cmd_nowplaying(self, player, channel, server, message):
        ...
        if player.current_entry:
            ...
            if player.current_entry.meta.get('channel', False) and player.current_entry.meta.get('author', False):
                np_text = ":arrow_forward: Now Playing: **%s** added by **%s** %s\n" % (
                    player.current_entry.title, player.current_entry.meta['author'].name, prog_str)
            else:
                np_text = ":arrow_forward: Now Playing: **%s** %s\n" % (player.current_entry.title, prog_str)
    ...
    async def cmd_queue(self, channel, player):
        ...
        if player.current_entry:
            ...
            if player.current_entry.meta.get('channel', False) and player.current_entry.meta.get('author', False):
                lines.append(":musical_note: Now Playing: **%s** added by **%s** %s\n" % (
                    player.current_entry.title, player.current_entry.meta['author'].name, prog_str))
            else:
                lines.append(":musical_note: Now Playing: **%s** %s\n" % (player.current_entry.title, prog_str))
